...
TimGraph::TimGraph(string graph_file, int node_cnt, int edge_cnt, int seed_size,string model, vector<int> banned_nodes)
:InfGraph(graph_file, node_cnt, edge_cnt, seed_size, model, banned_nodes){}
