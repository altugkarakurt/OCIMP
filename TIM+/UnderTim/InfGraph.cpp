...
InfGraph::InfGraph(string graph_file, int node_cnt, int edge_cnt, int seed_size, string model, vector<int> banned_nodes)
:Graph(graph_file, node_cnt, edge_cnt, seed_size, model, banned_nodes){
    hyperG.clear();
    for(int i=0; i<n; i++)
